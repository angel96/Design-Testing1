...
<p><spring:message code="customer.addshouts" /></p>
...
<form:form modelAttribute="shout">
	...
	<input type="button" name="cancel" value='<spring:message code="customer.cancel" />' onclick="javascript: relativeRedir('customer/links.do');" />
</form:form>
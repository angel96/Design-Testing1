	...
	<ul id="jMenu">
		...
		<security:authorize access="hasRole('ADMIN')">
			<li><a class="fNiv"><spring:message	code="master.page.administrator" /></a>
				<ul>
					<li class="arrow"></li>
					<li><a href="administrator/type-shouts.do"><spring:message code="master.page.administrator.action.1" /></a></li>
		...
		<security:authorize access="hasRole('CUSTOMER')">
			<li><a class="fNiv"><spring:message	code="master.page.customer" /></a>
				<ul>
					<li class="arrow"></li>
					<li><a href="customer/user-shouts.do"><spring:message code="master.page.customer.action.1" /></a></li>

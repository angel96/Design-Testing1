...
public class TestEndorsementService extends AbstractTest {
	...
	@Test
	public void getOne() {
		Assert.notNull(this.serviceEndorsement.findOne(3083));
	}
	...
	public void testUpdate() {
		...
		modified = this.serviceEndorsement.findOne(3083);
	...
	public void testDelete() {
		Assert.notNull(this.serviceEndorsement.findOne(3083));
		this.serviceEndorsement.delete(3083);
		Assert.isNull(this.serviceEndorsement.findOne(3083));
	}
}

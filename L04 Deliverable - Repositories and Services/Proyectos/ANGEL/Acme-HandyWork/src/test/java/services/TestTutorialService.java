...
public class TestTutorialService extends AbstractTest {
	...
	@Test
	public void getOne() {
		Assert.notNull(this.tutorialService.findOne(3007));
	}
	...
	public void updateTutorial() {
		super.authenticate("handyworker1");
		Tutorial t, updated;
		t = this.tutorialService.findOne(3007);
	...
	public void addSponsoshipToTutorial() {
		...
		Tutorial t1;
		t1 = this.tutorialService.findOne(3007);

		Sponsorship s1, savedS;
		s1 = Utiles.createSponsorship(this.sponsorService.findById(3012), t1);
	...
	public void removeTutorial() {
		super.authenticate("handyworker1");
		this.tutorialService.delete(3007);
		Assert.isNull(this.tutorialService.findOne(3007));
		super.unauthenticate();
	}
}

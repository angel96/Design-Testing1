...
public class CustomisationSystemService {
	...
	public Map<String, Double> dashboardRatioApplications() {
		...
		result.put("RatioPublishedWages", this.repositoryCustomisationSystem.findRatioPublishWagesPerTotalWages());
		result.put("RatioNonPublishedWages", this.repositoryCustomisationSystem.findRatioNotPublishWagesPerTotalWages());
	...
	public Map<String, double[]> dashboardStatistics() {
		...
		result.put("AvgAndStdOfPublishedWagesPerFixUpTask", Utiles.convertToArrayDoubleFromString(this.repositoryCustomisationSystem.stdAndAvgOfPublishedWagesPerTotatFixUpTask()));

...
public class ProfessionalRecordService {
	...
	public ProfessionalRecord save(final ProfessionalRecord p) {
		...
		Collection<ProfessionalRecord> pro;

		if (c.getProfessionalRecord().isEmpty() || c.getProfessionalRecord() == null)
			pro = new ArrayList<ProfessionalRecord>();
		else
			pro = c.getProfessionalRecord();

		pro.add(saved);
		c.setProfessionalRecord(pro);

...
<table border="1">
	...
	<tr>
		<td><spring:message code="custom.query1"></spring:message>
		<td>${statistics.get("AvgAndStdOfPublishedWagesPerFixUpTask")[0]}</td>
		<td></td>
		<td></td>
		<td>${statistics.get("AvgAndStdOfPublishedWagesPerFixUpTask")[3]}</td>
	<tr>
...
<table border="1">
	<tr>
		<th><spring:message code="custom.query2" /></th>
		<th><spring:message code="custom.query3" /></th>
	...
	<tr>
		<td>${ratioApplications.get('RatioPublishedWages')}</td>
		<td>${ratioApplications.get('RatioNonPublishedWages')}</td>

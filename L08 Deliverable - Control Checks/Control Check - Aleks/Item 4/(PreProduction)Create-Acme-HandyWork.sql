...
--
-- Table structure for table `fix_up_task_wages`
--

DROP TABLE IF EXISTS `fix_up_task_wages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `fix_up_task_wages` (
  `fix_up_task` int(11) NOT NULL,
  `wages` int(11) NOT NULL,
  UNIQUE KEY `UK_qmucdk1qakcnfm20udlmmfdx4` (`wages`),
  KEY `FK_8w5t5qwjie6823veb0j30bi49` (`fix_up_task`),
  CONSTRAINT `FK_8w5t5qwjie6823veb0j30bi49` FOREIGN KEY (`fix_up_task`) REFERENCES `fix_up_task` (`id`),
  CONSTRAINT `FK_qmucdk1qakcnfm20udlmmfdx4` FOREIGN KEY (`wages`) REFERENCES `wage` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `fix_up_task_wages`
--

LOCK TABLES `fix_up_task_wages` WRITE;
/*!40000 ALTER TABLE `fix_up_task_wages` DISABLE KEYS */;
/*!40000 ALTER TABLE `fix_up_task_wages` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `wage` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_s1d8wly1sffcst19nnkbie3qc` (`ticker`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-02-13  1:52:19

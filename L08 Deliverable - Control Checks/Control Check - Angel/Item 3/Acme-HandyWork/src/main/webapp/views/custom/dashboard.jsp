...
<p>
<h3>
	<spring:message code="custom.dashboard" />
</h3>
</p>
...
<table border="1">
	...
	<tr>
		...
		<td>${statistics.get("AoletsFixUpTask")[0]}</td>
		<td>${statistics.get("AoletsFixUpTask")[1]}</td>
		<td>${statistics.get("AoletsFixUpTask")[2]}</td>
		<td>${statistics.get("AoletsFixUpTask")[3]}</td>
	</tr>
	<tr>
		<td><spring:message code="custom.fixupperuser" /></td>
...
<table border="1">
	<tr>
		...
		<th><spring:message code="custom.publishedAolets" /></th>
		<th><spring:message code="custom.UnpublishedAolets" /></th>
	</tr>
	<tr>
		<td>${ratioApplications.get('RatioAoletsPublished')}</td>
		<td>${ratioApplications.get('RatioAoletsUnPublished')}</td>

...
public class TestCategoryService extends AbstractTest {
	...
	public void testFindOne() {
		super.authenticate("customer1");
		Assert.isTrue(this.categoryService.findOne(4109) != null);
		super.unauthenticate();
	}
	...
	public void testSaveSubCategory() {
		...
		c.setName("");
		c.setOtherlanguages(new ArrayList<String>());
		Assert.isTrue(this.categoryService.saveSubCategory(this.categoryService.findOne(4108).getId(), c) != null);
		super.unauthenticate();
	}
	...
	public void testDeleteCategory() {
		super.authenticate("admin1");
		Assert.isTrue(this.categoryService.findOne(4108) != null);
		this.categoryService.deleteCategory(4108);
		Assert.isNull(this.categoryService.findOne(4108));
		super.unauthenticate();
	}

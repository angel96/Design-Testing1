...
<display:table name="actors" id="row" requestURI="${requestURI}"
	...
	<display:column property="middleName" titleKey="endorsement.middleName" />
	...
	<display:column>
			<a href="endorsement/customer/create.do?idHandy=${row.id}"><spring:message
					code="endorsement.create" /></a>
	</display:column> 
	</security:authorize>
	<security:authorize access="hasRole('HANDY_WORKER')">
	<display:column>
			<a href="endorsement/handyworker/create.do?idHandy=${row.id}"><spring:message
					code="endorsement.create" /></a>
	</display:column> 
	</security:authorize>

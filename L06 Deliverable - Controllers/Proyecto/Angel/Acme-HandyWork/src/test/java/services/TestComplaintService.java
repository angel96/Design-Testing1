...
public class TestComplaintService extends AbstractTest {
	...
	@Test
	//TEST FOR SHOWING COMPLAINTS
	public void testGetComplaint() {
		super.authenticate("customer2");
		Assert.notNull(this.complaintService.findOne(5039));
		super.unauthenticate();
	}
	@Test
	//TEST FOR CREATING COMPLAINTS
	...
	@Test
	//TEST FOR LISTING COMPLAINTS THAT NO REFEREE ASSIGNED
	...
	@Test
	//TEST FOR LISTING COMPLAINTS THAT REFEREE ASSIGNED
	...
	@Test
	//TEST FOR LISTING COMPLAINTS THAT OWN REFEREE ASSIGNED
	...
	@Test
	//TEST FOR LISTING AND SHOWING COMPLAINTS BY HANDY WORKER ID

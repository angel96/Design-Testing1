...
<form:form modelAttribute="refereeObject" action="profile/referee/edit.do">
<form:hidden path="id"/>
...
<spring:message code="referee.address"></spring:message>
</form:label>
...
onclick="javascript:relativeRedir('profile/referee/edit.do');"/>

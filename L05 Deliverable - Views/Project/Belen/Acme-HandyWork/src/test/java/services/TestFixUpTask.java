...
@Transactional
public class TestFixUpTask extends AbstractTest {
	...
	public void testUpdate1() {
		super.authenticate("customer2");
		FixUpTask f, saved;
		f = this.fixUpTaskService.findOne(1225);
		f.setAddress("addressfixuptask6");
		saved = this.fixUpTaskService.update(f.getId(), f);
	...
	public void testDelete1() {
		super.authenticate("customer2");
		this.fixUpTaskService.delete(1225);
		Assert.isNull(this.fixUpTaskService.findOne(1225));
		super.authenticate(null);
	}
	...
	public void testUpdate2() {
		...
		f = this.fixUpTaskService.findOne(1224);
		f.setAddress("addressfixuptask6");
	...
	public void testDelete2() {
		super.authenticate("customer2");
		this.exception.expect(IllegalAccessError.class);
		this.fixUpTaskService.delete(1224);
		Assert.isNull(this.fixUpTaskService.findOne(1224));
		super.authenticate(null);
	}
}
